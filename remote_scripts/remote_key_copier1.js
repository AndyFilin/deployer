var fs = require('fs');
var key_out = fs.createWriteStream('/home/andreyfilin/nodescripts/key_out.log');
var spawn = require('child_process').spawn;
var err = 0;
var key_copy = spawn('expect', ['/home/andreyfilin/nodescripts/auto_key_copier1.sh']);
    ...
    key_copy.on('exit', function(code) {
        if (code == 0) {
            ...
            console.log('key seems to be on the remote computer already');
            err = 3;
        }
    });
